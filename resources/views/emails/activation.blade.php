									...
									<table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
										<tr>
											<td style="padding:0 0 15px 0;color:#153643;">
												...
												<p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">This is an automated account activation email</p>
											</td>
										</tr>
										<tr>
											<td>
												<p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
													@if ($company)
														@if ($company->authorization == "approved")
															Congratulations you're now activated to use <a href="https//:freyt365.com" target="_blank">https//:freyt365.com</a>.
															This is a secure platform for all services freyt365. Please click on the link provided and log in with your username and password.
															<br>
															<p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="https://freight365.com/login" style="color:#fcc02d;text-decoration:underline;" target="_blank">Click me to get started</a></p>
														@else
															Unfortunately your account was not activated to use <a href="https//:freyt365.com" target="_blank">https//:freyt365.com</a>.
															<br>
